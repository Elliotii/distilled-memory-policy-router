...
def build():
    ...
    for i in range(180):
        ...
        cases.append({"case_id":f"v05e_gold_{i+1:04d}","runtime_context":runtime,
                      ...
                      "tags":tags,"notes":f"v008 shape={shape}"})
...
def audit(active):
    ...
    gates = [
        ...
        ("real_sensitive_18_27",18<=real_sens<=27,True),("sensitive_stored",sens_stored,0),
...
def main():
    ...
    ap = base / "v05e_gold_v2_008_active_cases.jsonl"
    hp = base / "v05e_gold_v2_008_holdout_cases.jsonl"
