...
- Predictions: `data/v05b/model_predictions/qwen3_4b_lora_json_250_dev_predictions.jsonl`
...
- `qwen3_4b_lora_json_125_unit_json` from `data/v05b/model_predictions/qwen3_4b_lora_json_250_dev_predictions.jsonl`.

## Structural Metrics

| Interface | System | Parse success | Invalid memory ID | Invalid unit/span | Invalid target | Span copy error | Avg chars | Repair cost |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| unit_json | qwen3_4b_lora_json_125_unit_json | 100.0% | 0.0% | 0.0% | 0.0% | 0.0% | 129.49 | 2.4 |

## Semantic Metrics

| Interface | System | Exact | READ F1 | STORE unit F1 | STORE target acc | SKIP F1 | False store | Irrelevant read | Sensitive store |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| unit_json | qwen3_4b_lora_json_125_unit_json | 20.0% | 0.884 | 0.947 | 63.8% | 0.747 | 4.6% | 19.0% | 66.7% |
