...
- Predictions: `data/v05b/model_predictions/qwen3_4b_lora_json_125_dev_predictions.jsonl`
...
- `qwen3_4b_lora_json_125_unit_json` from `data/v05b/model_predictions/qwen3_4b_lora_json_125_dev_predictions.jsonl`.

## Structural Metrics

| Interface | System | Parse success | Invalid memory ID | Invalid unit/span | Invalid target | Span copy error | Avg chars | Repair cost |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| unit_json | qwen3_4b_lora_json_125_unit_json | 100.0% | 0.0% | 0.0% | 0.0% | 0.0% | 131.02 | 2.67 |

## Semantic Metrics

| Interface | System | Exact | READ F1 | STORE unit F1 | STORE target acc | SKIP F1 | False store | Irrelevant read | Sensitive store |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| unit_json | qwen3_4b_lora_json_125_unit_json | 11.0% | 0.889 | 0.910 | 55.7% | 0.535 | 9.5% | 16.3% | 33.3% |
