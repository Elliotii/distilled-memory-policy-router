...
- `deepseek_v4_flash_smoke` from `data/v04/model_predictions/p5_smoke_predictions.jsonl`.

## Structural Metrics

| Interface | System | Parse success | Invalid memory ID | Invalid unit/span | Invalid target | Span copy error | Avg chars | Repair cost |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| legacy_span_json | deepseek_v4_flash_smoke | 40.0% | 0.0% | 0.0% | 0.0% | 0.0% | 104.0 | 1.2 |
| unit_dsl | deepseek_v4_flash_smoke | 60.0% | 0.0% | 0.0% | 0.0% | 0.0% | 27.0 | 1.6 |
| unit_json | deepseek_v4_flash_smoke | 40.0% | 0.0% | 0.0% | 0.0% | 0.0% | 58.4 | 0.6 |

## Semantic Metrics

| Interface | System | Exact | READ F1 | STORE unit F1 | STORE target acc | SKIP F1 | False store | Irrelevant read | Sensitive store |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| legacy_span_json | deepseek_v4_flash_smoke | 20.0% | 0.444 | 0.286 | 100.0% | 0.600 | 0.0% | 0.0% | 0.0% |
| unit_dsl | deepseek_v4_flash_smoke | 20.0% | 0.400 | 0.667 | 66.7% | 0.800 | 0.0% | 33.3% | 0.0% |
| unit_json | deepseek_v4_flash_smoke | 40.0% | 0.444 | 0.286 | 100.0% | 0.667 | 0.0% | 0.0% | 0.0% |
